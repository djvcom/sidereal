...
//! cargo test -p sidereal --features s3 --test s3_integration -- --ignored
//! ```
...
use sidereal::config::{BufferConfig, ParquetConfig, StorageConfig};
...
use sidereal::storage::{base_url, create_object_store, Signal};
